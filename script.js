document.addEventListener("DOMContentLoaded", function() {
    ...
    function showDataType(data) {
        ...
        secondTextBox.style.display = 'none'; // Hide the second textbox if it's currently displayed
    }

    function showSecondTextBox(data) {
        ...
        dataTextBox.style.display = 'none'; // Hide the first textbox if it's currently displayed
    }
